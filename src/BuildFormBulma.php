...
class BuildFormBulma
{
    ...
    {
                // 1. Read the existing token generated by the application's init.php
        $this->token = $_SESSION['token'] ?? urlencode(base64_encode((random_bytes(32))));
        
        // 2. Remove the setcookie() call entirely. Let init.php and helpers.php 
        // handle cookie injection with the correct Domain scope.
