    ...
    public static function formAndMatchQuery(
        ...
        return match ($selection) {
            ...
            'SELECT_SUM' => "SELECT SUM($column) as total FROM $table WHERE $identifier1 = ?",
                 'SELECT_COUNT_ALL' => "SELECT COUNT(*) as total FROM $table",
            'SELECT_COUNT_ID' => "SELECT COUNT(*)as total FROM $table WHERE $identifier1 = ?",
            'SELECT_COL_COUNT_ID_GROUP' => "SELECT $column,COUNT(*) as total FROM $table WHERE $identifier1 = ? GROUP BY $column",
            'SELECT_COL_COUNT_2ID_GROUP' => "SELECT $column,COUNT(*) as total FROM $table WHERE $identifier1 = ? AND $identifier2 = ? GROUP BY $column",
