...
class Select extends Db
{
    ...
    public static function formAndMatchQuery(
        ...
        return match ($selection) {
            ...
            'SELECT_COUNT_ALL' => "SELECT COUNT(*) FROM $table",
            'SELECT_COUNT_ID' => "SELECT COUNT(*) FROM $table WHERE $identifier1 = ?",
            'SELECT_COL_COUNT_ID_GROUP' => "SELECT $column,COUNT(*) FROM $table WHERE $identifier1 = ? GROUP BY $column",
            'SELECT_COL_COUNT_2ID_GROUP' => "SELECT $column,COUNT(*) FROM $table WHERE $identifier1 = ? AND $identifier2 = ? GROUP BY $column",
