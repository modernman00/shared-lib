    ...
    public function logout(string $redirectPath = '/login', array $options = []): void
    {
        ...
        try {
            ...
            if (isset($_COOKIE[$tokenName])) {
                ...
                setcookie($tokenName, '', $cookieOptions);

                // Expire domain cookie if domain was configured or derived
                $cookieDomain = $_ENV['COOKIE_DOMAIN'] ?? $domain;
